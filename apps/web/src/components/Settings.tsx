...
interface CostData {
    ...
    limits: { dailyLimitEur: number; monthlyLimitEur: number; dailyUsedPercent: number; monthlyUsedPercent: number };
}
        ...
        <div className="settings-container">
                    ...
                    <div className="cost-grid">
                        ...
                        <div className="cost-card">
                            ...
                            <div className="budget-bar-wrap">
                                ...
                                <span className="budget-pct">{cost.limits.dailyUsedPercent.toFixed(0)}% of €{cost.limits.dailyLimitEur} limit</span>
                            </div>
                        </div>
                        {/* Month */}
                        <div className="cost-card">
                            ...
                            <div className="budget-bar-wrap">
                                ...
                                <span className="budget-pct">{cost.limits.monthlyUsedPercent.toFixed(0)}% of €{cost.limits.monthlyLimitEur} limit</span>
                            </div>
                        </div>
                        {/* Savings */}
            ...
            <section className="settings-section">
                ...
                <div className="about-grid">
                    ...
                    <div className="about-row"><span>Website</span>
                        <a href="https://lokaflow.com" target="_blank" rel="noreferrer">lokaflow.com</a>
                    </div>
                    <div className="about-row"><span>Sponsors</span>
                        <a href="https://github.com/sponsors/lokaflow" target="_blank" rel="noreferrer">github.com/sponsors/lokaflow</a>
                    </div>
                </div>
            </section>
        </div>
