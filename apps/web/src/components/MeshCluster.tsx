        ...
        <div className="mesh-container">
            ...
            {error && (
                <div className="mesh-error">
                    <WifiOff size={16} />
                    {error}
                    <span className="mesh-error-hint">Run: <code>npx tsx packages/cli/src/index.ts serve</code></span>
                </div>
            )}
                ...
                <>
                    ...
                    <div className="mesh-summary-row">
                        <div className="mesh-summary-card">
                            ...
                            <div>
                                <div className="mesh-stat">{onlineCount} / {health.providers.length}</div>
                    ...
                    {/* Provider tiers */}
                    {[
                        { label: 'Local Models', icon: <Cpu size={15} />, providers: localProviders, color: '#10b981' },
                        { label: 'Specialist Models', icon: <Zap size={15} />, providers: specialistProviders, color: '#8b5cf6' },
                        { label: 'Cloud Models', icon: <Cloud size={15} />, providers: cloudProviders, color: '#3b82f6' },
                    ].map(group => group.providers.length > 0 && (
