      ...
      <div className="cards">
        ...
        <div className="card">
          ...
          <div className="subtext">
            {stats?.today.localQueries || 0} local | {stats?.today.cloudQueries || 0} cloud
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="subtext">
            Monthly total: €{stats?.month.totalEur?.toFixed(2) || "0.00"}
          </div>
        </div>
        ...
        <div className="card">
          ...
          <p className="metric">{stats?.limits.dailyUsedPercent || 0}%</p>
        ...
        <div className="routing-table">
          ...
          {history.length === 0 && !historyLoading && (
            <div className="route-empty">
              No routing history yet — start the API and send a chat message.
            </div>
          )}
          {history.map((e, i) => (
            <div className="route-row" key={i}>
              ...
              <div className="route-model" title={e.model}>
                {shortModel(e.model)}
              </div>
              <div className="route-node" title={e.node}>
                {e.node ? fmtNode(e.node) : "—"}
              </div>
