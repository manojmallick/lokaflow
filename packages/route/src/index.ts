...
// ── Types ────────────────────────────────────────────────────────────────────
export type { RoutingTier, ClassifierFeatures, QueryContext, QueryClassification } from "./types/classification.js";
export type { ModelAssignment, RouteDecision, PolicyOverride, RoutingPolicy }      from "./types/routing.js";
export {       DEFAULT_TIER_MODELS, TIER_THRESHOLDS, scoreToTier, isLocalTier }    from "./types/routing.js";
export type { DailySummary, TierDistribution, FeedbackSignal, LearningRecord, UserClassificationBaseline } from "./types/tracking.js";
...
export type { CanonicalChatRequest, CanonicalChatResponse, CanonicalMessage } from "./proxy/openai-compat.js";
