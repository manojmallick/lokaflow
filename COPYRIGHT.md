# LokaFlow™ — Copyright Notice

```
Copyright (c) 2026 LearnHubPlay BV
All rights reserved.
```
...
This work is protected by copyright law under:

- **Dutch Auteurswet** (Copyright Act of the Netherlands)
- **EU Copyright Directive 2019/790** (applies across all 27 EU member states)
- **Berne Convention** (applies in 181 countries worldwide)

All source code, documentation, architecture designs, brand assets, and any
other original works contained in this repository are the exclusive property
of LearnHubPlay BV. Unauthorized reproduction, distribution, or commercial
use is prohibited without a written license from LearnHubPlay BV.
